...
## SC-004 Compliance Procedure

Zero false negatives/positives across 100 consecutive runs is validated by:
...
2. Manual validation: run the on-demand pipeline 5 times before each release and confirm all
   ...
   release checklist. Full 100-run automation is not required (FTL Spark limit: 5 tests/day).
...
3. Commit — no workflow YAML change required (FR-022)

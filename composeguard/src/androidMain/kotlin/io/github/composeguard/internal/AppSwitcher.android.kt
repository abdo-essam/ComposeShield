 ...
 * common code suppresses this call rather than double-applying (FR-015d).
 *
 ...
 * only the Overview representation, leaving user and Assistant screenshots working (research.md R7).
 *
 ...
 * reflection, which constitution Principle V forbids outright.
 */

...
/**
 * Initializes ComposeGuard's activity-lifecycle tracker before any [Activity.onCreate] runs.
 *
 ...
 */
internal class ComposeGuardInitializer : ContentProvider() {
 ...
 *
 * Split from [ComposeGuardInitializer] so it can also be called from [anyRegisteredActivity] as a

...
/**
 * Marks a declaration as an implementation detail of ComposeShield.
 *
...
@RequiresOptIn(
    ...
    message =
        "This is a ComposeShield implementation detail. It is excluded from the ABI dump " +
...
public annotation class InternalComposeShieldApi
